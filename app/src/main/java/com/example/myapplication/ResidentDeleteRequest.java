...
public class ResidentDeleteRequest {
    ...
    private final String endpoint = "https://itsmenewbie03.is-a.dev/appt/api/data/resident/delete";

    public void deleteUser(Context context, String target, String accessToken, VolleyListener listener) {
        try {
